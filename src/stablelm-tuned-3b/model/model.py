...
class Model:
    ...
    def load(self):
        model_name = "stabilityai/stablelm-tuned-alpha-3b" #@param ["stabilityai/stablelm-base-alpha-7b", "stabilityai/stablelm-tuned-alpha-7b", "stabilityai/stablelm-base-alpha-3b", "stabilityai/stablelm-tuned-alpha-3b"]
