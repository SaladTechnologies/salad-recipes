...
This deployment runs `Qwen3.5-35B-A3B` with the official `llama.cpp` CUDA server, downloads the public GGUF weights automatically on startup, and exposes an OpenAI-compatible API for tools such as OpenClaw, OpenCode, and other compatible clients.
