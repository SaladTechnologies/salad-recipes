...
The API supports all YOLOv8-compatible parameters as query params — including but not limited to:
...
These can be appended to any request URL.

[See the full list of YOLOv8 parameters →](https://docs.ultralytics.com/modes/predict/#optional-args)
