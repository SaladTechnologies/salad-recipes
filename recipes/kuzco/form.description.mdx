...
You must register a Kuzco worker and provide a valid CODE to use this recipe. Without it, the worker will fail to register with the Kuzco controller.
</Callout>
...
7. Copy the generated **Worker Code** and paste it into the <code>code</code> field in this recipe
