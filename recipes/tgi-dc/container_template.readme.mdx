...
## Example Models for 8×A100 Sharded Inference

With SaladCloud Secure’s **8×A100 GPU** nodes (40GB VRAM each), you can run very large models by sharding them across all GPUs. Below are some example models that work well with this setup:
