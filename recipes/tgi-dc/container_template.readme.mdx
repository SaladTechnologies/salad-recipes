...
With SaladCloud Secure’s **8×L40S GPU** nodes (48GB VRAM each), you can run very large models by sharding them across all GPUs. Below are some example models that work well with this setup:
