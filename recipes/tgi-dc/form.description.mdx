...
This recipe is defaulted to run on **8×A100 GPUs per node (40GB VRAM each)**. These nodes are ideal for serving large models with high throughput and parallelism.
