...
- **Inference**: `{`https://${props.networking.dns}`}`
- **Metadata**: `{`https://${props.networking.dns}/api/metadata`}`
- **Health Checks**:
    - `{`https://${props.networking.dns}/startup`}`
    - `{`https://${props.networking.dns}/live`}`
    - `{`https://${props.networking.dns}/ready`}`